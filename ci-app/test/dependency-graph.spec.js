...
describe('DependencyGraph class', () => {
  ...
  describe('readProjectDependencies()', () => {
    it('Reads dependencies from bower.json file', () => {
      ...
      return instance.readProjectDependencies()
      .then((result) => {
        ...
        assert.deepEqual(Object.keys(result[0]), [
          ...
          'api-type-documentation'], 'Has dependencies');
        assert.deepEqual(Object.keys(result[1]), [
          'iron-demo-helpers',
          'iron-component-page',
          'arc-polyfills',
          'oauth-authorization'], 'Has dev dependencies');
      });
    });
    ...
    it('Reads dependencies from package.json file', () => {
      ...
      .then((result) => {
        ...
        assert.deepEqual(Object.keys(result[0]), [
          '@polymer/polymer',
          '@advanced-rest-client/api-test1',
          '@api-components/api-test2'], 'Has dependencies');
        assert.deepEqual(Object.keys(result[1]), [
          '@polymer/iron-demo-helpers',
          '@polymer/iron-component-page',
          '@advanced-rest-client/arc-test1',
          '@api-components/arc-test2'], 'Has dev dependencies');
      });
    });
  });
  ...
  describe('filterDependencies()', () => {
    it('Filters bower dependencies', () => {
      ...
      .then((data) => {
        ...
        assert.deepEqual(devResult, ['arc-polyfills',
        'oauth-authorization'], 'Has dev dependencies');
      });
    });
    ...
    it('Filters package dependencies', () => {
      ...
      .then((data) => {
        const result = instance.filterDependencies(data[0]);
        assert.deepEqual(result, ['@advanced-rest-client/api-test1',
        '@api-components/api-test2'], 'Has dependencies');
        const devResult = instance.filterDependencies(data[1]);
        assert.deepEqual(devResult, ['@advanced-rest-client/arc-test1',
        '@api-components/arc-test2'], 'Has dev dependencies');
      });
    });
  });
    ...
    it('Builds graph for bower components', () => {
      ...
      .then(() => {
        ...
        assert.deepEqual(spy.args[0][2],
          ['arc-polyfills', 'oauth-authorization'],
